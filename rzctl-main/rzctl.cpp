...
extern "C" __declspec(dllexport) void mouse_move(int x, int y, bool from_start_point) {
	rzctl::mouse_move(x, y, from_start_point);
}

extern "C" __declspec(dllexport) void mouse_click(int up_down) {
	rzctl::mouse_click(up_down);
}
